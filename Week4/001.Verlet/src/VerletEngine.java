...
public class VerletEngine extends Application
{
    ...
    private final Button btnCover = new Button("Cover");
    ...
    public void start(Stage stage)
    {
        ...
        btnSave.setOnAction(e -> save("positions.txt"));
        btnLoad.setOnAction(e -> load("positions.txt"));
    ...
    private void mouseClicked(MouseEvent e)
    {
        if (e.getButton() == MouseButton.PRIMARY)
        {
            ...
            if (e.isShiftDown())
            {
                ...
                constraints.add(new Rope(newParticle, nearest, 150));
            }
            else
            {
                particles.add(newParticle);
        ...
        else if (e.getButton() == MouseButton.SECONDARY)
        {
            ...
            else
            {
                ...
                sorted.sort(new Comparator<Particle>() {
                    @Override
        ...
        if (e.getButton() == MouseButton.PRIMARY && e.isControlDown())
        {
            ...
            constraints.add(new Static(newParticle));
        }
    }
    ...
    private void cover()
    {
        ...
        for (int i = 0; i < width; i++)
        {
            ...
            Static aStatic = new Static(particle);
